...
start "Sudha Clinic - Backend Server" cmd /k "cd /d "%~dp0backend" && set "JAVA_HOME=C:\Program Files\Java\jdk-17" && set "PATH=C:\tools\apache-maven-3.9.6\bin;C:\Program Files\Java\jdk-17\bin;%PATH%" && mvn spring-boot:run"
